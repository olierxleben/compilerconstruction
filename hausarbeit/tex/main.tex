...
\pagebreak
\thispagestyle{empty}
% TODO: Abstract fertig schreiben
\begin{abstract}
\textbf{Zusammenfassung:}\\ 	
Die vorliegende Arbeit wurde in LaTex verfasst und ist eine gemeinsame Arbeit von Oliver Erxleben, Sergej Hert und Jörn Voßgröne. Die Arbeit beschäftigt sich mit der Optimierung von Cascading Stylesheets für Webseiten. 
\end{abstract}
